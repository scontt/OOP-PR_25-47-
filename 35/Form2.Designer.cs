namespace WindowsFormsApp1
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Программа позволяет вычислить цепную дробь (x/(1 + x/(2 + x/(3 + x/(.../(N + x))." +
    "..)) для заданных пользователем вещественного x и натурального N с использование" +
    "м рекурсивной функции\r\n";
